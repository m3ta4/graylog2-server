...
public class StreamResource extends RestResource {
    ...
    @AuditLog(action = AuditActions.STREAM_CREATE)
    ...
    @AuditLog(action = AuditActions.STREAM_UPDATE)
    ...
    @AuditLog(action = AuditActions.STREAM_DELETE)
    ...
    @AuditLog(action = AuditActions.STREAM_STOP)
    ...
    @AuditLog(action = AuditActions.STREAM_START)
