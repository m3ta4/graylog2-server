...
public class UsersResource extends RestResource {
    ...
    @AuditLog(action = AuditActions.USER_CREATE, excludeFields = {"password"})
    ...
    @AuditLog(action = AuditActions.USER_UPDATE)
    ...
    @AuditLog(action = AuditActions.USER_DELETE)
    ...
    @AuditLog(action = AuditActions.USER_PERMISSIONS_UPDATE)
    ...
    @AuditLog(action = AuditActions.USER_PREFERENCES_UPDATE)
    ...
    @AuditLog(action = AuditActions.USER_PERMISSIONS_DELETE)
    ...
    @AuditLog(action = AuditActions.USER_PASSWORD_UPDATE, excludeFields = {"old_password", "password"})
    ...
    @AuditLog(action = AuditActions.USER_ACCESS_TOKEN_CREATE, excludeFields = "token")
    ...
    @AuditLog(action = AuditActions.USER_ACCESS_TOKEN_DELETE)
