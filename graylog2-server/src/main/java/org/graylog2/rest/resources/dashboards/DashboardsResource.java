...
public class DashboardsResource extends RestResource {
    ...
    @AuditEvent(action = AuditActions.DASHBOARD_CREATE)
    ...
    @AuditEvent(action = AuditActions.DASHBOARD_DELETE)
    ...
    @AuditEvent(action = AuditActions.DASHBOARD_UPDATE)
    ...
    @AuditEvent(action = AuditActions.DASHBOARD_WIDGET_POSITIONS_UPDATE)
