...
public class DashboardsResource extends RestResource {
    ...
    @AuditLog(action = AuditActions.DASHBOARD_CREATE)
    ...
    @AuditLog(action = AuditActions.DASHBOARD_DELETE)
    ...
    @AuditLog(action = AuditActions.DASHBOARD_UPDATE)
    ...
    @AuditLog(action = AuditActions.DASHBOARD_WIDGET_POSITIONS_UPDATE)
